...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Id_Asientos'])) {
    $id_asiento = $_POST['Id_Asientos'];
    ...
    $sql = "UPDATE tb_asientos 
            SET Id_Salas='$id_sala', Numero_de_asientos='$numero_de_asientos', Fila='$fila', Estado='$estado' 
            WHERE Id_Asientos='$id_asiento'";
